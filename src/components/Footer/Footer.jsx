...
const Footer = () => {
  return (
    <footer className="mugil-container w-100">
      ...
      <div className="footer-body">
        <div className="footer-body-wrapper">
          <div className="footer-body-link-container">
            ...
            <div className="footer-icons py-4 flex-wrap">
              <a href="https://www.youtube.com/@vasi_glass_kallakurichi_y2q" target="_blank" className="footer-icons-wrap">
          ...
          <div className="footer-body-link-container">
            ...
            <p className="card-text pb-3">Mugil Elite Mart provides a wide range of plywood, glass, bathroom fittings, kitchen accessories, and home décor products.</p>
            <p>We combine quality, variety, and affordability to cater to both retail and wholesale customers.</p>
          </div>
          <div className="footer-body-link-container">
      ...
      <div className="footer-bottom d-flex gap-3 justify-content-between align-items-center">
        <p>Copyright © 2025 by Mugil Elite mart. All Rights Reserved.</p>
        <p className="pe-3 pe-lg-5 pt-2 pt-lg-0">Designed by
          <a className="text-decoration-none devx-logo"
            target="_blank"
            href="https://devxthinkdesign.com/">
            <img src="https://devxthinkdesign.com/assets/img/DEVX-IMAGES/devx_white_logo.png" alt="devx" />
          </a>
        </p>
      </div>
    </footer >
