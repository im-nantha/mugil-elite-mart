        ...
        <div className="d-flex justify-content-between align-items-center flex-column flex-md-row">
          <div className="d-flex align-items-center gap-2">
            <NavLink className="mugil-footer-logo-wrapper" to="/mugil-elite-mart/" >
              <img className="mugil-mart-img" alt="mugil-mart-logo" src="/mugil-elite-mart/src/assets/images/mem-logo.png" />
            </NavLink>
        ...
        <div className="footer-body-wrapper">
          <div className="footer-body-link-container">
            ...
            <div className="footer-icons py-4">
              <NavLink to="https://youtube.com/@vasiglass2288?si=6ZjOLie23uTgAeAP" target="_blank" className="footer-icons-wrap">
